...
- **Tests**: 168 unit tests across 22 test files passing (auth, agent, cache, tools, webhook, response policy, inbound use case + processor, escalation expiry, maintenance, unit-of-work, postgres module DI wiring, dashboard/knowledge controllers).
